...
func init() {
	DemoMap["shader.bricks"] = &ShaderBricks{}
}
...
func (t *ShaderBricks) Start(a *App) {
...
func (t *ShaderBricks) Update(a *App, deltaTime time.Duration) {
...
func (t *ShaderBricks) Cleanup(a *App) {}
