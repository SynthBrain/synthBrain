...
func init() {
	DemoMap["gui.builder"] = &GuiBuilder{}
}
...
func (t *GuiBuilder) Update(a *App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *GuiBuilder) Cleanup(a *App) {}

func (t *GuiBuilder) build(a *App, fpath string) {
