...
func init() {
	DemoMap["audio.capture"] = &AudioCapture{}
}
...
func (t *AudioCapture) Start(a *App) {
...
func (t *AudioCapture) Update(a *App, deltaTime time.Duration) {
...
func (t *AudioCapture) Cleanup(a *App) {
