...
import (
	...
	"github.com/SynthBrain/synthBrain/util"
...
func init() {
	DemoMap["loader.collada"] = &LoaderCollada{}
}
...
func (t *LoaderCollada) Start(a *App) {
...
func (t *LoaderCollada) load(a *App, path string) error {
...
func (t *LoaderCollada) Update(a *App, deltaTime time.Duration) {
...
func (t *LoaderCollada) Cleanup(a *App) {}
