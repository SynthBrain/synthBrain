...
func init() {
	DemoMap["gui.custom_cursors"] = &CustomCursors{}
}
...
func (t *CustomCursors) Start(a *App) {
...
func (t *CustomCursors) Update(a *App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *CustomCursors) Cleanup(a *App) {}
