...
func init() {
	DemoMap["texture.cone-cylinder"] = &TexConeCylinder{}
}
...
func (t *TexConeCylinder) Start(a *App) {
...
func (t *TexConeCylinder) Update(a *App, deltaTime time.Duration) {
...
func (t *TexConeCylinder) Cleanup(a *App) {}
