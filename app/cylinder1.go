...
func init() {
	DemoMap["geometry.cone-cylinder"] = &ConeCylinder{}
}
...
func (t *ConeCylinder) Start(a *App) {
...
func (t *ConeCylinder) Update(a *App, deltaTime time.Duration) {
...
func (t *ConeCylinder) Cleanup(a *App) {}
