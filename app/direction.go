...
func init() {
	DemoMap["audio.direction"] = &AudioDirection{}
}
...
func (t *AudioDirection) Start(a *App) {
...
func (t *AudioDirection) Update(a *App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *AudioDirection) Cleanup(a *App) {}
...
func NewPlayerCone(app *App, filename string, color *math32.Color) *PlayerCone {
