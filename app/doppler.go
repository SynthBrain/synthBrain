...
func init() {
	DemoMap["audio.doppler"] = &AudioDoppler{}
}
...
func (t *AudioDoppler) Start(a *App) {
...
func (t *AudioDoppler) Update(a *App, deltaTime time.Duration) {
...
func (t *AudioDoppler) Cleanup(a *App) {}

func (ps *PlayerSphere) UpdateVel(a *App, deltaTime time.Duration) {
