...
func init() {
	DemoMap["shader.geometry"] = &ShaderGeometry{}
}
...
func (t *ShaderGeometry) Start(a *App) {
...
func (t *ShaderGeometry) Update(a *App, deltaTime time.Duration) {
...
func (t *ShaderGeometry) Cleanup(a *App) {}
