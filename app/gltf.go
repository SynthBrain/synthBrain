...
func init() {
	DemoMap["loader.gltf"] = &GltfLoader{}
}
...
func (t *GltfLoader) loadScene(a *App, fpath string) error {
...
func (t *GltfLoader) Update(a *App, deltaTime time.Duration) {
...
func (t *GltfLoader) Cleanup(a *App) {}
