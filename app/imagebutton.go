...
func init() {
	DemoMap["gui.imagebutton"] = &GuiImageButton{}
}

type GuiImageButton struct{}

// Start is called once at the start of the demo.
func (t *GuiImageButton) Start(a *App) {
...
func (t *GuiImageButton) Update(a *App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *GuiImageButton) Cleanup(a *App) {}
