...
func init() {
	DemoMap["gui.imagelabel"] = &GuiImageLabel{}
}

type GuiImageLabel struct{}

// Start is called once at the start of the demo.
func (t *GuiImageLabel) Start(a *App) {
...
func (t *GuiImageLabel) Update(a *App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *GuiImageLabel) Cleanup(a *App) {}
