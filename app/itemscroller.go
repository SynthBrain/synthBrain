...
func init() {
	DemoMap["gui.itemscroller"] = &GuiScroller{}
}

type GuiScroller struct{}

// Start is called once at the start of the demo.
func (t *GuiScroller) Start(a *App) {
...
func (t *GuiScroller) Update(a *App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *GuiScroller) Cleanup(a *App) {}
