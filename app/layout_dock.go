...
func init() {
	DemoMap["gui.layout_dock"] = &GuiLayoutDock{}
}

type GuiLayoutDock struct{}

// Start is called once at the start of the demo.
func (t *GuiLayoutDock) Start(a *App) {
...
func (t *GuiLayoutDock) Update(a *App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *GuiLayoutDock) Cleanup(a *App) {}
