...
func init() {
	DemoMap["gui.layout_grid"] = &GuiLayoutGrid{}
}
...
func (t *GuiLayoutGrid) Start(a *App) {
...
func (t *GuiLayoutGrid) Update(a *App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *GuiLayoutGrid) Cleanup(a *App) {}
