...
func init() {
	DemoMap["gui.layout_hbox"] = &GuiLayoutHBox{}
}

type GuiLayoutHBox struct{}

// Start is called once at the start of the demo.
func (t *GuiLayoutHBox) Start(a *App) {
...
func (t *GuiLayoutHBox) Update(a *App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *GuiLayoutHBox) Cleanup(a *App) {}
