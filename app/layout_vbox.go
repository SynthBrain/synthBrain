...
func init() {
	DemoMap["gui.layout_vbox"] = &GuiLayoutVBox{}
}

type GuiLayoutVBox struct{}

// Start is called once at the start of the demo.
func (t *GuiLayoutVBox) Start(a *App) {
...
func (t *GuiLayoutVBox) Update(a *App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *GuiLayoutVBox) Cleanup(a *App) {}
