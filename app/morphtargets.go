...
func init() {
	DemoMap["other.morphtargets"] = &MorphTargets{}
}
...
func (t *MorphTargets) Start(a *App) {
...
func (t *MorphTargets) Update(a *App, deltaTime time.Duration) {
...
func (t *MorphTargets) Cleanup(a *App) {}
