...
func init() {
	DemoMap["animation.morphtargets"] = &AnimationMorphTargets{}
}
...
func (t *AnimationMorphTargets) Start(a *App) {
...
func (t *AnimationMorphTargets) Update(a *App, deltaTime time.Duration) {
...
func (t *AnimationMorphTargets) Cleanup(a *App) {}
