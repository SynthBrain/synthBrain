...
func (t *LoaderObj) load(a *App, path string) error {
...
func (t *LoaderObj) Update(a *App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *LoaderObj) Cleanup(a *App) {}
