...
func init() {
	DemoMap["gui.panel_children"] = &GuiPanelChildren{}
}
...
func (t *GuiPanelChildren) Start(a *App) {
...
func (t *GuiPanelChildren) Update(a *App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *GuiPanelChildren) Cleanup(a *App) {}
