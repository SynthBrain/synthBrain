...
func init() {
	DemoMap["gui.panel_modal"] = &GuiPanelModal{}
}
...
func (t *GuiPanelModal) Start(a *App) {
...
func (t *GuiPanelModal) setModal(a *App, p gui.IPanel) {
...
func (t *GuiPanelModal) createPanel(a *App) *gui.Panel {
...
func (t *GuiPanelModal) Update(a *App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *GuiPanelModal) Cleanup(a *App) {}
