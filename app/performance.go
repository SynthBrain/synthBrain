...
func init() {
	DemoMap["other.performance"] = &Performance{}
}

type Performance struct{}

// Start is called once at the start of the demo.
func (t *Performance) Start(a *App) {
...
func (t *Performance) Update(a *App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *Performance) Cleanup(a *App) {}
