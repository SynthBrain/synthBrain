...
func init() {
	DemoMap["material.physical_helmet"] = &PhysicalHelmet{}
}
...
func (t *PhysicalHelmet) Start(a *App) {
...
func (t *PhysicalHelmet) Update(a *App, deltaTime time.Duration) {
...
func (t *PhysicalHelmet) Cleanup(a *App) {}
