...
func init() {
	DemoMap["material.physical_variations"] = &PhysicalVariations{}
}
...
func (t *PhysicalVariations) Start(a *App) {
...
func (t *PhysicalVariations) Update(a *App, deltaTime time.Duration) {
...
func (t *PhysicalVariations) Cleanup(a *App) {}
