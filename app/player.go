...
func init() {
	DemoMap["audio.player"] = &AudioPlayer{}
}
...
func (t *AudioPlayer) Start(a *App) {
...
func (t *AudioPlayer) Update(a *App, deltaTime time.Duration) {
...
func (t *AudioPlayer) Cleanup(a *App) {}
...
func NewPlayerControl(a *App, filename string) (*PlayerControl, error) {
