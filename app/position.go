...
func init() {
	DemoMap["audio.position"] = &AudioPosition{}
}
...
func (t *AudioPosition) Start(a *App) {
...
func (t *AudioPosition) Update(a *App, deltaTime time.Duration) {
...
func (t *AudioPosition) Cleanup(a *App) {}
...
func NewPlayerSphere(a *App, filename string, color *math32.Color) *PlayerSphere {
...
func (ss *PlayerSphere) Update(a *App) {
