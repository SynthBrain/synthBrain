...
func init() {
	DemoMap["gui.scrollbar"] = &GuiScrollBar{}
}

type GuiScrollBar struct{}

// Start is called once at the start of the demo.
func (t *GuiScrollBar) Start(a *App) {
...
func (t *GuiScrollBar) Update(a *App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *GuiScrollBar) Cleanup(a *App) {}
