...
func init() {
	DemoMap["physics-experimental.sphere_box"] = &PhysicsSphereBox{}
}
...
func (t *PhysicsSphereBox) Start(a *App) {
...
func (t *PhysicsSphereBox) Update(a *App, deltaTime time.Duration) {

	t.sim.Step(float32(deltaTime.Seconds()))
}

// Cleanup is called once at the end of the demo.
func (t *PhysicsSphereBox) Cleanup(a *App) {}
