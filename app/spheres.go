...
func init() {
	DemoMap["physics-experimental.spheres"] = &PhysicsSpheres{}
}
...
func (t *PhysicsSpheres) Start(a *App) {
...
func (t *PhysicsSpheres) Update(a *App, deltaTime time.Duration) {
...
func (t *PhysicsSpheres) Cleanup(a *App) {}
