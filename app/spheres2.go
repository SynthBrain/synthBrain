...
func init() {
	DemoMap["physics-experimental.spheres2"] = &PhysicsSpheres2{}
}
...
func (t *PhysicsSpheres2) Start(a *App) {
...
func (t *PhysicsSpheres2) Update(a *App, deltaTime time.Duration) {

	t.sim.Step(float32(deltaTime.Seconds()))
}

// Cleanup is called once at the end of the demo.
func (t *PhysicsSpheres2) Cleanup(a *App) {}
