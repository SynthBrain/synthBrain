...
func init() {
	DemoMap["other.sprite_anim"] = &SpriteAnim{}
}
...
func (t *SpriteAnim) Update(a *App, deltaTime time.Duration) {
...
func (t *SpriteAnim) Cleanup(a *App) {}
