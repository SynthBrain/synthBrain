...
func (t *GuiTabBar) setTabMenu(a *App, tab *gui.Tab) {
...
func (t *GuiTabBar) Update(a *App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *GuiTabBar) Cleanup(a *App) {}
